...
year_course_text = font_text.render("Year: 2023   Course Code: 7805ICT Software Design", True, black)
students_text = font_text.render("Students: Ashish Kumar, and Harsh Patel", True, black)
...
def show_quit_dialog(screen):
    ...
    dialog_text = font.render("Do you want to end the game?", True, white)
...
pygame.display.set_caption("Tetris by Harsh and Ashish")
run = True
while run:
